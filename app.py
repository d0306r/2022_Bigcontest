...
def main() :
    ...
    #주소별 온실가스 배출량 불러오기
    df = pd.read_csv('C:/Users/82109/OneDrive/바탕 화면/dataset/TB_ECO_BUILDING_GHG_GIS_JEJU_1920.csv', thousands=',', encoding='euc-kr')
    ...
    #2022년 숙박 자료만 남기고 제거
    df_3 = pd.read_csv('C:/Users/82109/OneDrive/바탕 화면/dataset/JT_MT_ACCTO_TRRSRT_SCCNT_LIST.csv', thousands=',', encoding='cp949')
